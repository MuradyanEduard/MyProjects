...
function ShowActiveElections() {
    ...
    UseDatabaseInfo("query_requests/ElectionSelect.php?table=election&active=1");
...
function SelectedElInfo(tmNom,nom){
    ...
    UseDatabaseInfo("query_requests/ElectionSelect.php?id="+nom);
...
function ArchiveBar(){
    ClearBlocks();
    UseDatabaseInfo("query_requests/ElectionSelect.php?table=election&active=0");
}

function WatchSelection(nom){
    ClearBlocks();    
    UseDatabaseInfo("query_requests/ElectionSelect.php?id="+nom+"&active="+0);
}
