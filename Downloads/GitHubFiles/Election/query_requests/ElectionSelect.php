    ...
    if(isset($_GET['table']) && isset($_GET['active'])){
        ...
        if($_GET['active']==0){
            ...
            if($row['ElType'] == 1)
                ...
                if($_SESSION['Permission']==1){
                    echo '<div class="innerCell"><a class="button" style="position:absolute;padding: 10px;" href="query_requests/ElectionDelete.php?id='.$row['IdElection'].'" onclick="return confirm(\'դուք վստա՞հ եք\');">X</a></div>';
                }
                echo "</div>";
        ...
        if(isset($_GET['active'])){
            ...
            if($row['ElType'] == 1)
                ...
                if($_SESSION["Permission"] == 1){
                    echo '<form style = "margin:20px;" onsubmit="return confirm(\'դուք վստա՞հ եք\');" action="query_requests/ElectionDelete.php">';
                    ...
                    echo '<form style = "margin:20px;" onsubmit="return confirm(\'դուք վստա՞հ եք\');" action="query_requests/ElectionCreate.php" method = "post">';
